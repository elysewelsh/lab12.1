...
1. Why is the path module necessary when serving files? What could go wrong if you just used a relative path like 'public/index.html'?
...
1. How would you add a third page (e.g., a menu page) to this server? What steps would you take?
